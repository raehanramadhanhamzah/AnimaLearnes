...
import static com.example.animalearnes.source.IkanSource.dataIkan;
...
import com.example.animalearnes.adapter.IkanAdapter;
...
public class IkanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rv_ikan = findViewById(R.id.rv_mamalia);
        IkanAdapter ikanAdapter = new IkanAdapter(dataIkan);
        rv_ikan.setHasFixedSize(true);
        rv_ikan.setAdapter(ikanAdapter);
        ...
        btnIkan.setOnClickListener(v -> recreate());
